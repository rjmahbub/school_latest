    ...
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{ route('AttendanceStudent') }}" method="post">
                ...
                <table class="table table-responsive">
                    ...
                    @foreach($students as $student)
                        <tr>
                            <td>
                                <div class="icheck-success d-inline">
                                    <input type="checkbox" name="st{{ $student->student_id }}" id="st{{ $student->student_id }}" @if($prsnt[$student->student_id] == "P") checked @endif>
                ...
                <a href="{{ route('UpdateAttendanceForm') }}?student" class="btn btn-info float-left"><i class="fa fa-arrow-left"></i> Previous</a>
            ...
            <form action="{{ route('AttendanceTeacher') }}" method="post">
                ...
                <table class="table table-responsive ml-4">
                    ...
                    @foreach($teachers as $teacher)
                        <tr>
                            <td>
                                <div class="icheck-success d-inline">
                                    <input type="checkbox" name="tcr{{ $teacher->id }}" id="tcr{{ $teacher->id }}" @if($prsnt[$teacher->id] == "P") checked @endif>
                ...
                <a href="{{ route('UpdateAttendanceForm') }}?teacher" class="btn btn-info float-left"><i class="fa fa-arrow-left"></i> Previous</a>
                <button type="submit" class="btn btn-success px-4 ml-5">Submit</button>
            </form>
            @else
            <div class="form-group clearfix">
                <div class="icheck-primary d-inline">
                    <input type="radio" id="student" name="TeacherOrStudent" checked @if(isset($_GET['teacher'])) checked @endif>
                    <label for="student">Student</label>
                </div>
                <div class="icheck-primary d-inline ml-3">
                    <input type="radio" name="TeacherOrStudent" id="teacher" @if(isset($_GET['teacher'])) checked @endif>
            ...
            <script>
                ...
                function changeRadio(){
                    $('form').hide();
                    var s = $('#student').prop('checked');
                    var t = $('#teacher').prop('checked');
                    if(s == true){
                        $('#studentForm').show();
                    }
                    if(t == true){
            ...
            <form id="studentForm" action="{{ route('UpdateAttendanceForm') }}">
            ...
            <form style="display:none;" id="teacherForm" action="">
                <div class="form-group">
                    <label for="date">Attendance Date <span class="text-danger">*</span></label>
                    <div class="input-group mb-3">
                    <div class="input-group-prepend">
