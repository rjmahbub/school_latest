...
@section('content')
<form style="width:700px;margin:auto;" action="{{ route('SaveStudent') }}" method="POST" enctype="multipart/form-data">
    <div class="card">
        <div class="card-body">
            @csrf
            ...
            <div class="row">
                <div class="fild_box d-flex">
                    <div class="col-md-3 col-5 label_div ng-binding"> Roll</div>
                    <div class="col-md-9 col-7 input_field">
                        <input type="number" name="roll" class="input-shadow edutab" placeholder="roll">
                    </div>
                </div>
                <div class="fild_box d-flex mt-2">
                    <div class="col-md-3 col-5 label_div ng-binding"> Student Name</div>
                    <div class="col-md-9 col-7 input_field">
                        <input type="text" name="full_name" class="input-shadow edutab" placeholder="full name">
                    </div>
                </div>
                <div class="fild_box d-flex mt-2">
                ...
                <div class="fild_box d-flex mt-2">
                    <div class="col-md-3 col-5 label_div ng-binding"> Mobile (guardian)</div>
                    <div class="col-md-9 col-7 input_field">
